...
const Courses = () => {
  ...
  const cursos = [
    ...
    },
    {
      ...
      descripcion:
        "Programa de <strong>mejoramiento personal</strong> basado en el pensamiento del ajedrecista.",
    ...
    {
      id: "ajedrez-psicologia",
      titulo: "Curso de Psicología Aplicada al Ajedrez",
      descripcion:
        "Autor: <strong>Lic. Santiago Mellano</strong> (Psicólogo, docente de ajedrez).\nPrograma basado en <strong>psicología deportiva</strong> aplicado al ajedrez.\nIncluye técnicas para regular la <strong>ansiedad</strong>, sostener la <strong>concentración</strong>, y construir una <strong>mentalidad ganadora</strong>.",
      ruta: "/courses/ajedrez-psicologia",
    }
  ];
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <motion.h2 className="text-3xl font-bold text-center text-white mb-8">
          Cursos Disponibles
        </motion.h2>
          ...
          {cursos.map((curso) => (
            ...
            >
              ...
              <p className="text-white mb-4">
                {formatDescription(curso.descripcion)}
              </p>
